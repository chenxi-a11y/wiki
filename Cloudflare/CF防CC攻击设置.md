...
确定您的网站被CF保护，也就是说DNS→是打开了代理，A/AAAA解析是橙色。（如果您之前[IP](https://www.corvk.com/archives/tag/ip)漏了，那么就需要换IP）
...
![免费版CloudFlare如何防CC攻击？不需要动手写规则！](./tp/CF防CC攻击设置.tp/636cb1b07e0b3.png)
...
![免费版CloudFlare如何防CC攻击？不需要动手写规则！](./tp/CF防CC攻击设置.tp/636cb1d5a25c7.png)

第三步：

CF→安全性→自动程序：打开自动程序攻击模式

![免费版CloudFlare如何防CC攻击？不需要动手写规则！](./tp/CF防CC攻击设置.tp/636cb1f118cb5.png)
...
![免费版CloudFlare如何防CC攻击？不需要动手写规则！](./tp/CF防CC攻击设置.tp/636cb21c229dc.png)

![免费版CloudFlare如何防CC攻击？不需要动手写规则！](https://img.8b5.cn/2022/11/10/636cb21f28c15.png)

第五步：在CF网络→路由→洋葱路由关掉

![免费版CloudFlare如何防CC攻击？不需要动手写规则！](./tp/CF防CC攻击设置.tp/636cb24024d42.png)

最后等cf规则生效，大概30秒，一定要重启一下服务器，让服务器断开所有的程序连接

不要依赖在服务器上设置防火墙，因为流量已经到你服务器了，只要攻击够大，64/128核都可以干废。同样CF也会自动机器学习，哪怕设置好以后，服务器短暂满载，过一会，CF就会通过[AI](https://www.corvk.com/archives/tag/ai)学习，不停的更新规则，这个规则更新不需要你人工干预。CF为什么免费？就是因为免费用户被攻击拿来做机器学习。别担心CF免费扛不住，或者被清退。理论上您被一次性攻击几十亿，CF还会拿你做文章